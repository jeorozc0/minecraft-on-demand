...
import { useMcServerConfiguration } from "@/lib/hooks/useServerConfig";
...
export default function ConfigurationPage() {
    ...
    if (!isLoadingConfig) {
      setFormState(
        ...
        ServerConfigurationSchema.parse({
          version: "1.21", // Provide required fields for default generation
          type: "PAPER",
        }),
      );
    }
  ...
  const isDestructiveChange = useMemo(() => {
    if (!initialConfig || !formState.version || !formState.type) {
      return false;
    }
    return (
